...
public class Plugin : BasePlugin
{
    ...
    // ///
    // /// .sanguinearchives-example "some quoted string" 1 1.5
    // /// .sanguinearchives-example boop 21232
    // /// .sanguinearchives-example boop-boop
    // ///</remarks>
    // [Command("sanguinearchives-example", description: "Example command from sanguinearchives", adminOnly: true)]
